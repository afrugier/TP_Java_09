...
public class PizzaDaoJpaTest {
	...
	static PizzaDaoJpa pizzaJpa = new PizzaDaoJpa();;
	...
	@Test
	public void testFindAllPizzasJpa() throws Exception {
		assertThat(listePizza).containsAll(pizzaJpa.findAllPizzas());
	}

	@Test
	public void testSaveNewPizza() throws Exception {
		Pizza pizza = new Pizza("HAW", "Hawaienne", 12.50, CategoriePizza.VIANDE);
		pizzaJpa.saveNewPizza(pizza);
		assertThat(pizzaJpa.findAllPizzas()).contains(pizza);
	}
	...
	public void testUpdatePizza() throws Exception {
		...
		pizzaJpa.updatePizza(codePizza, pizza);
		assertThat(pizzaJpa.findAllPizzas()).contains(pizza);
	}
	...
	public void testDeletePizza() throws Exception {
		...
		pizzaJpa.deletePizza(codePizza);
		assertThat(pizzaJpa.findAllPizzas()).doesNotContain(pizza);
	}
}
